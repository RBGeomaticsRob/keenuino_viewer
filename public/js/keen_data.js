  ...
  client.run([templog_1_s0, templog_1_s1, templog_1_s2, templog_1_s3, templog_1_s4], function(err, res){
    ...
    while (i < result1.length) {
        ...
        data[i]={ // format the data so it can be charted
            ...
            value: [
                { category: "External", result: result1[i]["value"] },
                { category: "Top Panel", result: result2[i]["value"] },
                { category: "AROS", result: result3[i]["value"] },
                { category: "PSU", result: result4[i]["value"] },
                { category: "Comms", result: result5[i]["value"] }
            ]
        }
